...
class ChuckCoreAPIEndpointTests: XCTestCase {
    ...
    func testRandomEndpointRequestGeneration() {
        let request = ChuckAPIEndpoint.random.request
    ...
    func testRandomWithCategoryRequestGeneration() {
        let request = ChuckAPIEndpoint.random(with: "dev").request
    ...
    func testCategoriesRequestGeneration() {
        let request = ChuckAPIEndpoint.categories.request
    ...
    func testSimpleSearchRequestGeneration() {
        let request = ChuckAPIEndpoint.search(with: "iPhone").request
    ...
    func testSearchWithSpecialCharactersRequestGeneration() {
        let request = ChuckAPIEndpoint.search(with: "Caffè Macs").request
